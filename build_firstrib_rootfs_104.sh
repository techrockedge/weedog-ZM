...
# Revision 1.0.4 Date: 14 Mar 2020
...
_usage (){
	case "$1" in
		'-v'|'--version') echo "Build FirstRib firstrib_rootfs Revision 1.0.4";exit;;
...
_void_repo_mirrors (){
	if [ -s "./firstrib.repo" ];then
		...
		do
			printf '
Tier 1 mirrors
1 http://alpha.de.repo.voidlinux.org  EU: Germany
2 http://beta.de.repo.voidlinux.org   EU: Germany
3 http://alpha.us.repo.voidlinux.org  USA: Kansas City
4 http://mirror.clarkson.edu          USA: New York
5 http://mirrors.servercentral.com    USA: Chicago
Tier 2 mirrors
6 http://mirror.aarnet.edu.au         AU: Canberra
7 http://ftp.swin.edu.au              AU: Melbourne
8 http://ftp.acc.umu.se               EU: Sweden
9 https://mirrors.dotsrc.org          EU: Denmark
10 http://www.gtlib.gatech.edu        USA: Atlanta
11 https://void.webconverger.org      APAN: Singapore
12 http://ftp.lysator.liu.se          EU: Sweden
...
Please make your choice '
			...
			case $choice in
				...
				'2'|'02') repo="https://beta.de.repo.voidlinux.org";break;;
				'3'|'03') repo="https://alpha.us.repo.voidlinux.org";break;;
				'4'|'04') repo="https://mirror.clarkson.edu/voidlinux";break;;
				'5'|'05') repo="https://mirrors.servercentral.com/voidlinux";break;;
				'6'|'06') repo="https://mirror.aarnet.edu.au/pub/voidlinux";break;;
				'7'|'07') repo="https://ftp.swin.edu.au/voidlinux";break;;
				'8'|'08') repo="https://ftp.acc.umu.se/mirror/voidlinux.eu";break;;
				'9'|'09') repo="https://mirrors.dotsrc.org/voidlinux";break;;
				'10') repo="www.gtlib.gatech.edu/pub/VoidLinux";break;;
				'11') repo="https://void.webconverger.org";break;;
				'12') repo="https://ftp.lysator.liu.se/pub/voidlinux";break;;
				'13') repo="https://lysator7eknrfl47rlyxvgeamrv7ucefgrrlhk7rouv3sna25asetwid.onion/pub/voidlinux";break;;
