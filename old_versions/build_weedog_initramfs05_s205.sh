#!/bin/sh
# Build_weedog_initramfs05_s205 to create WeeDog Linux initramfs Model05
# (s205 means [s]witch_root revision 2.0.5) 
...
kernel="$1"
case "$1" in
	'-v'|'--version') echo "Build WeeDog initramfs05 [s]witch_root Revision 2.0.5";exit;;
	'-h'|'--help'|'-?') printf '
Usage:
